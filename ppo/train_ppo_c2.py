"""
Train PPO — Condition C2 (sensor noise, static obstacles).
"""
import sys, os
import numpy as np
import torch
...
LOG_DIR    = "./logs/ppo_c2/"
SAVE_DIR   = "./models/ppo_c2/"
BEST_DIR   = "./models/ppo_c2/best/"
FINAL_PATH = os.path.join(SAVE_DIR, "ppo_c2_final")
...
checkpoint_cb = CheckpointCallback(
    save_freq=10_000, save_path=SAVE_DIR, name_prefix="ppo_c2"
)
...
print("=== PPO C2 — Sensor Noise Training ===")
model.learn(
