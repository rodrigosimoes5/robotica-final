"""
Train PPO — Condition C3 (clean sensors, critical dynamic obstacles).
"""
import sys, os
import numpy as np
import torch
...
LOG_DIR    = "./logs/ppo_c3/"
SAVE_DIR   = "./models/ppo_c3/"
BEST_DIR   = "./models/ppo_c3/best/"
FINAL_PATH = os.path.join(SAVE_DIR, "ppo_c3_final")
...
checkpoint_cb = CheckpointCallback(
    save_freq=10_000, save_path=SAVE_DIR, name_prefix="ppo_c3"
)
...
print("=== PPO C3 — Dynamic Obstacles Training ===")
model.learn(
