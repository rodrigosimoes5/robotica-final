"""
Train DQN — Condition C4 (noise + dynamic obstacles — most demanding).
"""
import sys, os
import numpy as np
import torch
...
LOG_DIR    = "./logs/dqn_c4/"
SAVE_DIR   = "./models/dqn_c4/"
BEST_DIR   = "./models/dqn_c4/best/"
FINAL_PATH = os.path.join(SAVE_DIR, "dqn_c4_final")
...
checkpoint_cb = CheckpointCallback(
    save_freq=10_000, save_path=SAVE_DIR, name_prefix="dqn_c4"
)
...
print("=== DQN C4 — Combined (Noise + Dynamic) Training ===")
model.learn(
